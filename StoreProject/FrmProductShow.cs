    ...
    private void getAllProductToLV()
        {
            ...
            string connectionString = @"Server=;Database=store_db;Trusted_Connection=True";
            ...
            using (SqlConnection sqlConnection = new SqlConnection(connectionString))
            {
...

                {
                    ...
                    string strSQL = "SELECT proId, proName, proPrice, proQuan, proImage FROM product_tb";
                    ...
                    using (SqlDataAdapter dataAdapter = new SqlDataAdapter(strSQL, sqlConnection))
                    {
                        ...
                        foreach (DataRow dataRow in dataTable.Rows)
                        {
                            ...
                            {
                                byte[] imgBte = (byte[])dataRow["proImage"];
                                proImage = convertByteArrayToImage(imgBte);
